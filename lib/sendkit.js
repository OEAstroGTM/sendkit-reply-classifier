...
export const analyticsOverview = (params) =>
  api("GET", `/v1/analytics/overview${params ? "?" + new URLSearchParams(params) : ""}`);
export const analyticsDaily = (params) =>
  api("GET", `/v1/analytics/daily${params ? "?" + new URLSearchParams(params) : ""}`);
